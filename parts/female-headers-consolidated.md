...
### Total Inventory
- **Total Quantity**: 200+ pieces across all types
- **Cabinet**: Cabinet-3 (primary location)
- **Bin Range**: Bins 44-60 (various sections)
- **Types**: 6 distinct categories
...
### 6. 1mm Spacing Dual Row Female Headers
...
### 7. Specific 0.1" Spacing Headers Collection
...
- **I2C**: 4-pin single row (Bin 57-B), 2-pin stacking (Bin 45-A)
